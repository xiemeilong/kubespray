...
7. The corresponding version of [quay.azk8s.cn/kubespray/kubespray:vX.Y.Z](https://quay.azk8s.cn/repository/kubespray/kubespray) and [quay.azk8s.cn/kubespray/vagrant:vX.Y.Z](https://quay.azk8s.cn/repository/kubespray/vagrant) docker images are built and tagged
